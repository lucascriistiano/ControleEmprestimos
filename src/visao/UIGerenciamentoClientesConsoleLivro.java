...
public class UIGerenciamentoClientesConsoleLivro implements UIGerenciamentoClientes {
	...
	public void cadastrarCliente() {
		...
		try {
			...
			System.out.println("Erro ao cadastrar data de admissão. Verifique o formato inserido.");
		}
	}
		...
		try {
			...
			for(Cliente cliente : clientes) {
				if(cliente instanceof Aluno) {
					...
					System.out.print(" - Titulação: " + professor.getTitulacao());
					System.out.print(" - Data de Admissão: " + new SimpleDateFormat("dd/MM/yyyy").format(professor.getDataAdmissao()));
				}
