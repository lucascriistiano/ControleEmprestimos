...
public class MainCarro {
	...
	private static UIGerenciamentoClientes uiClientes = new UIGerenciamentoClientesConsoleCarro();
	private static UIGerenciamentoUsuarios uiUsuarios = new UIGerenciamentoUsuariosConsole();
	private static UIGerenciamentoRecursos uiRecursos = new UIGerenciamentoRecursosConsoleCarro();
	private static UIGerenciamentoEmprestimos uiEmprestimos = new UIGerenciamentoEmprestimosConsoleCarro();
