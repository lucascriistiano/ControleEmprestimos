...
public class MainQuarto {
	...
	private static UIGerenciamentoClientes uiClientes = new UIGerenciamentoClientesConsoleQuarto();
	private static UIGerenciamentoUsuarios uiUsuarios = new UIGerenciamentoUsuariosConsole();
	private static UIGerenciamentoRecursos uiRecursos = new UIGerenciamentoRecursosConsoleQuarto();
	private static UIGerenciamentoEmprestimos uiEmprestimos = new UIGerenciamentoEmprestimosConsoleQuarto();
	...
	private static void populateDAOs() {
		...
		Recurso quarto1 = new Quarto(Long.valueOf(1), "1� andar", 700, 1, 2, 1000);
		Recurso quarto2 = new Quarto(Long.valueOf(2), "2� andar", 500, 2, 3, 2000);
		Recurso quarto3 = new Quarto(Long.valueOf(3), "3� andar", 600, 3, 4, 5000);
		...
		ClienteLocadorQuarto cliente1 = new ClienteLocadorQuarto(Long.valueOf(1), "Pedro Inácio", "123.456.789-10", "endereco1", "1233456784",calendar.getTime());
		
		calendar.set(Calendar.DAY_OF_MONTH, 31);
		calendar.set(Calendar.MONTH, 4);
		calendar.set(Calendar.YEAR, 1965);
		ClienteLocadorQuarto cliente2 = new ClienteLocadorQuarto(Long.valueOf(2), "Juvenal da Costa", "456.890.123-22", "endereco2", "7125782334",calendar.getTime());
