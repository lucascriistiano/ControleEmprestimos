...
public class ComprovanteEmprestimoBuilderBiblioteca implements ComprovanteEmprestimoBuilder {
	...
	public ComprovanteEmprestimo getComprovante() {
		return new ComprovanteEmprestimoBiblioteca("ZN Biblioteca", locador, codigo, dataEmprestimo, dataDevolucao, recursos);
	}
}
