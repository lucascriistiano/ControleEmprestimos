...
public class ComprovanteDevolucaoBuilderCarro implements ComprovanteDevolucaoBuilder {
	...
	public ComprovanteDevolucao getComprovante() {
		return new ComprovanteDevolucaoCarro("LoCar Locadora", locador, codigo, dataEmprestimo, dataDevolucao, recursos, valor);
	}
}
