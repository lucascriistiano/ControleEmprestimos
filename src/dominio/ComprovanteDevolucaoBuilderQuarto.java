...
public class ComprovanteDevolucaoBuilderQuarto implements ComprovanteDevolucaoBuilder {
	...
	public ComprovanteDevolucao getComprovante() {
		return new ComprovanteDevolucaoCarro("H Hotel", locador, codigo, dataEmprestimo, dataDevolucao, recursos, valor);
	}
}
