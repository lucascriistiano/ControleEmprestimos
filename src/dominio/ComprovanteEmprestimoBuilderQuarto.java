...
public class ComprovanteEmprestimoBuilderQuarto implements ComprovanteEmprestimoBuilder {
	...
	public ComprovanteEmprestimo getComprovante() {
		return new ComprovanteEmprestimoCarro("H Hotel", locador, codigo, dataEmprestimo, dataDevolucao, recursos);
	}
}
