...
public class ComprovanteEmprestimoBuilderCarro implements ComprovanteEmprestimoBuilder {
	...
	public ComprovanteEmprestimo getComprovante() {
		return new ComprovanteEmprestimoCarro("LoCar Locadora", locador, codigo, dataEmprestimo, dataDevolucao, recursos);
	}
}
