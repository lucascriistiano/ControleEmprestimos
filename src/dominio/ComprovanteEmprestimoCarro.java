...
public class ComprovanteEmprestimoCarro extends ComprovanteEmprestimo {
    
	public ComprovanteEmprestimoCarro(String empresa, String locador, Long codigo, Date dataEmprestimo, Date dataDevolucao, List<Recurso> recursos) {
	...
	public void imprimir() {
		...
		System.out.println("Data da devolucao definida: " + this.getDataDevolucao());
