...
public class ClienteLocadorQuarto extends Cliente{
	...
	public ClienteLocadorQuarto(Long codigo, String nome) {
		super(codigo, nome);
	}
	
	public ClienteLocadorQuarto(Long codigo, String nome, String cpf, String rg, String endereco, Date dataNascimento) {
		super(codigo, nome);
