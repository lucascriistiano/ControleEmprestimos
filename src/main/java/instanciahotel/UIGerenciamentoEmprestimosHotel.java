...
public class UIGerenciamentoEmprestimosHotel implements UIGerenciamentoEmprestimos {
	...
	private GerenciadorEmprestimos gerenciadorEmprestimos = new GerenciadorEmprestimos(new RegraHotel(),
			new GeradorComprovanteHotel(), new FabricaNotificacaoHotel(), new GerenciadorDatas());
